<?php $__env->startSection('title', 'Prazos e Notificações'); ?>

<?php $__env->startSection('content_header'); ?>
    <h1>
        <i class="fas fa-clock"></i> Monitoramento de Prazos - Pacote #<?php echo e($pacote->id); ?>

        <a href="<?php echo e(route('pacotes.show', $pacote->id)); ?>" class="btn btn-sm btn-secondary float-right">
...
<?php $__env->startSection('content'); ?>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo e(route('pacotes.show', $pacote->id)); ?>">Pacote #<?php echo e($pacote->id); ?></a></li>
            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number"><?php echo e($pacote->numero_fatura); ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number">R$ <?php echo e(number_format($pacote->valor_fatura, 2, ',', '.')); ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number">R$ <?php echo e(number_format($pacote->valor_glosa, 2, ',', '.')); ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="info-box">
                                <span class="info-box-icon <?php echo e($pacote->localizacao_atual == 'glosa' ? 'bg-warning' : 'bg-info'); ?>">
                                    <i class="fas fa-map-marker-alt"></i>
                                </span>
                                <div class="info-box-content">
                                    <span class="info-box-text">Localização Atual</span>
                                    <span class="info-box-number"><?php echo e(ucfirst($pacote->localizacao_atual)); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="status-indicator text-center mb-4">
                        ...
                        <div class="status-icon text-<?php echo e($statusClass); ?>">
                            <i class="fas fa-<?php echo e($statusIcon); ?> fa-5x"></i>
                        </div>
                        <div class="status-text mt-2">
                            <h4><?php echo e($statusText); ?></h4>
                            <p class="text-muted"><?php echo e($pacote->estado_glosa); ?></p>
                        </div>
                    </div>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    <?php if($pacote->data_notificacao_glosa && !$pacote->data_retirada_oficio): ?>
                        <!-- Prazo para Retirada de Ofício -->
                        <div class="countdown-box text-center p-3 mb-4 <?php echo e($pacote->prazoRetiradaExcedido() ? 'bg-danger' : ($pacote->diasRetiradaRestantes() <= 3 ? 'bg-warning' : 'bg-info')); ?>">
                            <h5 class="text-white">Prazo para Retirada do Ofício</h5>
                            
                            <?php if($pacote->prazoRetiradaExcedido()): ?>
                                <div class="countdown-timer">
                                    <i class="fas fa-exclamation-triangle fa-3x text-white mb-2"></i>
                                    <h3 class="text-white">PRAZO EXPIRADO</h3>
                                    <p class="text-white">
                                        Excedido em <?php echo e(intval(abs($pacote->diasRetiradaRestantes()))); ?> dias
                                    </p>
                                </div>
                            <?php else: ?>
                                <div class="countdown-timer">
                                    <i class="fas fa-hourglass-half fa-3x text-white mb-2"></i>
                                    <h2 class="text-white"><?php echo e(intval($pacote->diasRetiradaRestantes())); ?></h2>
                                    <p class="text-white">
                                        Dias Restantes
                                    </p>
                                </div>
                    ...
                    <?php elseif($pacote->data_retirada_oficio && !$pacote->data_recebimento_recurso): ?>
                        ...
                        <div class="countdown-box text-center p-3 mb-4 <?php echo e($recursoExpirado ? 'bg-danger' : ($diasRestantesRecurso <= 3 ? 'bg-warning' : 'bg-info')); ?>">
                            <h5 class="text-white">Prazo para Recurso de Glosa</h5>
                            
                            <?php if($recursoExpirado): ?>
                                <div class="countdown-timer">
                                    <i class="fas fa-exclamation-triangle fa-3x text-white mb-2"></i>
                                    <h3 class="text-white">PRAZO EXPIRADO</h3>
                                    <p class="text-white">
                                        Excedido em <?php echo e(intval(abs($diasRestantesRecurso))); ?> dias
                                    </p>
                                </div>
                            <?php else: ?>
                                <div class="countdown-timer">
                                    <i class="fas fa-hourglass-half fa-3x text-white mb-2"></i>
                                    <h2 class="text-white"><?php echo e(intval($diasRestantesRecurso)); ?></h2>
                                    <p class="text-white">
                                        Dias Restantes
                                    </p>
                                </div>
                    ...
                    <?php if($pacote->data_recebimento_recurso): ?>
                        ...
                        <div class="countdown-box text-center p-3 mb-4 <?php echo e($analiseExpirada ? 'bg-danger' : ($diasRestantesAnalise <= 5 ? 'bg-warning' : 'bg-success')); ?>">
                            <h5 class="text-white">Prazo Interno - Análise de Recurso</h5>
                            
                            <?php if($analiseExpirada): ?>
                                <div class="countdown-timer">
                                    <i class="fas fa-exclamation-triangle fa-3x text-white mb-2"></i>
                                    <h3 class="text-white">PRAZO EXPIRADO</h3>
                                    <p class="text-white">
                                        Excedido em <?php echo e(intval(abs($diasRestantesAnalise))); ?> dias
                                    </p>
                                </div>
                            <?php else: ?>
                                <div class="countdown-timer">
                                    <i class="fas fa-hourglass-half fa-3x text-white mb-2"></i>
                                    <h2 class="text-white"><?php echo e(intval($diasRestantesAnalise)); ?></h2>
                                    <p class="text-white">
                                        Dias Restantes
                                    </p>
                                </div>
                    ...
                    <?php if($pacote->valor_glosa > 0 && !$pacote->data_notificacao_glosa): ?>
                        <div class="alert alert-warning mt-3">
                            <i class="fas fa-bell"></i> Ação Pendente: Notificar Existência de Glosa
                        </div>
                    <?php elseif($pacote->data_notificacao_glosa && !$pacote->data_retirada_oficio): ?>
                        <div class="alert alert-info mt-3">
                            <i class="fas fa-bell"></i> Ação Pendente: Registrar Retirada de Ofício
                        </div>
                    <?php elseif($pacote->data_retirada_oficio && !$pacote->data_recebimento_recurso && $pacote->estado_glosa == 'Aguardando Recurso de Glosa'): ?>
                        <div class="alert alert-info mt-3">
                            <i class="fas fa-bell"></i> Ação Pendente: Registrar Recebimento de Recurso ou Recurso Não Recebido
                        </div>
                    <?php elseif($pacote->data_recebimento_recurso && !isset($pacote->valor_deferido)): ?>
                        <div class="alert alert-info mt-3">
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                            ...
                            <div class="col-6">
                                <div class="finance-item mb-3">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <span class="font-weight-bold">R$ <?php echo e(number_format($pacote->valor_pos_lisura, 2, ',', '.')); ?></span>
                                    </div>
                                </div>
                                <div class="finance-item mb-3">
                                    <div class="d-flex justify-content-between">
                                        <span><i class="fas fa-circle text-danger"></i> Valor Glosa:</span>
                                        <span class="font-weight-bold">R$ <?php echo e(number_format($pacote->valor_glosa, 2, ',', '.')); ?></span>
                                    </div>
                                </div>
                            </div>
                            
                            <div class="col-6">
                                <?php if($pacote->data_recebimento_recurso && isset($pacote->valor_deferido)): ?>
                                <div class="finance-item mb-3">
                                    <div class="d-flex justify-content-between">
                                        <span><i class="fas fa-circle text-warning"></i> Valor Recursado:</span>
                                        <span class="font-weight-bold">R$ <?php echo e(number_format($pacote->valor_recurso_glosa ?? 0, 2, ',', '.')); ?></span>
                                    </div>
                                </div>
                                <div class="finance-item mb-3">
                                    <div class="d-flex justify-content-between">
                                        <span><i class="fas fa-circle text-info"></i> Valor Deferido:</span>
                                        <span class="font-weight-bold">R$ <?php echo e(number_format($pacote->valor_deferido ?? 0, 2, ',', '.')); ?></span>
                                    </div>
                                </div>
                                <?php endif; ?>
                            </div>
                    ...
                    <?php if($pacote->data_recebimento_recurso && isset($pacote->valor_deferido) && isset($pacote->valor_recurso_glosa) && $pacote->valor_recurso_glosa > 0): ?>
                        <?php
                        ...
                        <div class="mt-4">
                            ...
                            <div class="progress">
                                <div class="progress-bar bg-info" style="width: <?php echo e($taxaDeferimento); ?>%"><?php echo e(number_format($taxaDeferimento, 1)); ?>%</div>
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
                    ...
                    <div class="timeline timeline-inverse">
                        ...
                        <div>
                            ...
                            <div class="timeline-item">
                                <span class="time"><i class="fas fa-clock"></i> <?php echo e($pacote->created_at->format('d/m/Y H:i')); ?></span>
                                <h3 class="timeline-header"><a>Glosa Identificada</a></h3>
                                <div class="timeline-body">
                                    Foi identificada glosa no valor de R$ <?php echo e(number_format($pacote->valor_glosa, 2, ',', '.')); ?>, 
                                    representando <?php echo e(number_format(($pacote->valor_glosa / $pacote->valor_fatura) * 100, 2)); ?>% do valor original da fatura.
                                </div>
                            </div>
                        </div>
                        
                        <!-- Notificação de Glosa -->
                        <?php if($pacote->data_notificacao_glosa): ?>
                            <div>
                                <i class="fas fa-bell bg-blue"></i>
                                <div class="timeline-item">
                                    <span class="time"><i class="fas fa-clock"></i> <?php echo e($pacote->data_notificacao_glosa->format('d/m/Y H:i')); ?></span>
                                    <h3 class="timeline-header"><a>Notificação de Existência de Glosa</a></h3>
                                    <div class="timeline-body">
                                        OCS/PSA <?php echo e($pacote->ocsPsa->nome); ?> foi notificada sobre a existência de glosa.
                                        Data limite para retirada: <?php echo e($pacote->data_limite_retirada ? $pacote->data_limite_retirada->format('d/m/Y') : 'Não definida'); ?>
                        ...
                        <!-- Retirada de Ofício -->
                        <?php if($pacote->data_retirada_oficio): ?>
                            <div>
                                <i class="fas fa-file-download bg-green"></i>
                                <div class="timeline-item">
                                    <span class="time"><i class="fas fa-clock"></i> <?php echo e($pacote->data_retirada_oficio->format('d/m/Y H:i')); ?></span>
                                    <h3 class="timeline-header"><a>Retirada do Ofício de Glosa</a></h3>
                                    <div class="timeline-body">
                                        Ofício de glosa foi retirado pela OCS/PSA <?php echo e($pacote->ocsPsa->nome); ?>.
                                        <?php
                                            $diasAteRetirada = $pacote->data_retirada_oficio->diffInDays($pacote->data_notificacao_glosa);
                                        ?>
                                        <br>
                                        <span class="text-muted">
                                            Tempo entre notificação e retirada: <?php echo e($diasAteRetirada); ?> dias
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <?php if($pacote->data_recebimento_recurso): ?>
                            <div>
                                ...
                                <div class="timeline-item">
                                    <span class="time"><i class="fas fa-clock"></i> <?php echo e($pacote->data_recebimento_recurso->format('d/m/Y H:i')); ?></span>
                                    <h3 class="timeline-header"><a>Recebimento de Recurso de Glosa</a></h3>
                                    <div class="timeline-body">
                                        Recurso de glosa recebido da OCS/PSA <?php echo e($pacote->ocsPsa->nome); ?>.
                                        <?php if(isset($pacote->valor_recurso_glosa)): ?>
                                            <br>Valor recursado: R$ <?php echo e(number_format($pacote->valor_recurso_glosa, 2, ',', '.')); ?>
                                        ...
                                        <br>
                                        <span class="text-muted">
                                            Tempo entre retirada e recurso: <?php echo e($diasAteRecurso); ?> dias
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <?php if($pacote->data_recebimento_recurso && isset($pacote->valor_deferido)): ?>
                            <div>
                                ...
                                <div class="timeline-item">
                                    <span class="time"><i class="fas fa-clock"></i> <?php echo e(now()->format('d/m/Y')); ?></span>
                                    <h3 class="timeline-header"><a>Análise do Recurso de Glosa</a></h3>
                                    <div class="timeline-body">
                                        Análise concluída com valor deferido de R$ <?php echo e(number_format($pacote->valor_deferido, 2, ',', '.')); ?>

                                        (<?php echo e($pacote->valor_recurso_glosa > 0 ? number_format(($pacote->valor_deferido / $pacote->valor_recurso_glosa) * 100, 1) : 0); ?>% do valor recursado).
                                    </div>
                                </div>
                            </div>
                        <?php endif; ?>
                        ...
                        <?php if($pacote->estado_glosa == 'Recurso não recebido'): ?>
                            <div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    <div class="row">
                        <?php if($pacote->valor_glosa > 0 && !$pacote->data_notificacao_glosa && (Auth::user()->isAdmin() || Auth::user()->hasRole('glosa'))): ?>
                            <div class="col-md-3">
                        ...
                        <?php if($pacote->data_notificacao_glosa && !$pacote->data_retirada_oficio && (Auth::user()->isAdmin() || Auth::user()->hasRole('glosa'))): ?>
                            <div class="col-md-3">
                        ...
                        <?php if($pacote->data_retirada_oficio && !$pacote->data_recebimento_recurso && (Auth::user()->isAdmin() || Auth::user()->hasRole('protocolo'))): ?>
                            <div class="col-md-3">
                        ...
                        <?php if($pacote->data_recebimento_recurso && !isset($pacote->valor_deferido) && (Auth::user()->isAdmin() || Auth::user()->hasRole('glosa'))): ?>
                            <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <a href="<?php echo e(route('pacotes.movimentacoes', $pacote->id)); ?>" class="btn btn-secondary btn-block mb-3">
                                <i class="fas fa-history mr-2"></i> Ver Histórico Completo
                            </a>
                        </div>
                        
                        <div class="col-md-3">
                            <a href="<?php echo e(route('pacotes.show', $pacote->id)); ?>" class="btn btn-outline-primary btn-block mb-3">
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        $(function() {
            ...
            const valorPosLisura = <?php echo e($pacote->valor_pos_lisura); ?>;
            const valorGlosa = <?php echo e($pacote->valor_glosa); ?>;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/admin21ct/pmed2/resources/views/pacotes/prazos.blade.php ENDPATH**/ ?>