<?php $__env->startSection('title', 'Pacotes'); ?>
    ...
    <div class="card">
        <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs" id="pacotesTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link <?php echo e($localizacaoAtiva == 'protocolo' ? 'active' : ''); ?>" id="protocolo-tab" data-toggle="tab" href="#protocolo" role="tab" 
                       aria-controls="protocolo" aria-selected="<?php echo e($localizacaoAtiva == 'protocolo' ? 'true' : 'false'); ?>">Protocolo</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e($localizacaoAtiva == 'lisura' ? 'active' : ''); ?>" id="lisura-tab" data-toggle="tab" href="#lisura" role="tab" 
                       aria-controls="lisura" aria-selected="<?php echo e($localizacaoAtiva == 'lisura' ? 'true' : 'false'); ?>">Lisura</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e($localizacaoAtiva == 'sire' ? 'active' : ''); ?>" id="sire-tab" data-toggle="tab" href="#sire" role="tab" 
                       aria-controls="sire" aria-selected="<?php echo e($localizacaoAtiva == 'sire' ? 'true' : 'false'); ?>">SIRE</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e($localizacaoAtiva == 'glosa' ? 'active' : ''); ?>" id="glosa-tab" data-toggle="tab" href="#glosa" role="tab" 
                       aria-controls="glosa" aria-selected="<?php echo e($localizacaoAtiva == 'glosa' ? 'true' : 'false'); ?>">Glosa</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e($localizacaoAtiva == 'arquivo' ? 'active' : ''); ?>" id="arquivo-tab" data-toggle="tab" href="#arquivo" role="tab" 
                       aria-controls="arquivo" aria-selected="<?php echo e($localizacaoAtiva == 'arquivo' ? 'true' : 'false'); ?>">Arquivo</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e($localizacaoAtiva == 'arquivados' ? 'active' : ''); ?>" id="arquivados-tab" data-toggle="tab" href="#arquivados" role="tab" 
                       aria-controls="arquivados" aria-selected="<?php echo e($localizacaoAtiva == 'arquivados' ? 'true' : 'false'); ?>">Arquivados</a>
                </li>
            </ul>
        </div>
        <div class="card-body">
            <div class="tab-content" id="pacotesTabContent">
                <!-- TAB PROTOCOLO -->
                <div class="tab-pane fade <?php echo e($localizacaoAtiva == 'protocolo' ? 'show active' : ''); ?>" id="protocolo" role="tabpanel" aria-labelledby="protocolo-tab">
                    <div class="mb-3">
                    ...
                    <table id="tabela-protocolo" class="table table-bordered table-striped dataTable">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $pacotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pacote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($pacote->localizacao_atual == 'protocolo' || 
                                    ($pacote->localizacao_atual == 'glosa' && $pacote->estado_glosa == 'Aguardando Recurso de Glosa')): ?>
                                    <tr class="<?php echo e($pacote->localizacao_atual == 'glosa' ? 'aguardando-recurso' : ''); ?>">
                                        <td>
                                            <?php if($pacote->localizacao_atual == 'protocolo'): ?>
                                                <input type="checkbox" class="check-item-protocolo" value="<?php echo e($pacote->id); ?>">
                                            <?php else: ?>
                                        ...
                                        <td><?php echo e(optional($pacote->ocsPsa)->nome); ?></td>
                                        <td><?php echo e(date('d/m/Y', strtotime($pacote->data_entrada))); ?></td>
                                        <td>R$ <?php echo e(number_format($pacote->valor_fatura, 2, ',', '.')); ?></td>
                                        <td><?php echo e(optional($pacote->tipoPacote)->nome); ?></td><!-- Nova coluna adicionada -->
                                        <td>
                                            <?php if($pacote->localizacao_atual == 'glosa'): ?>
                                                <span class="badge badge-info">Aguardando Recurso</span>
                                            <?php else: ?>
                                                <span class="badge badge-<?php echo e($pacote->estado_geral == 'Normal' ? 'success' : 'warning'); ?>">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <?php if((Auth::user()->role == 'admin' || Auth::user()->role == 'protocolo') && $pacote->localizacao_atual == 'protocolo'): ?>
                                                    <a href="<?php echo e(route('pacotes.edit', $pacote->id)); ?>" class="btn btn-sm btn-primary">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                <?php endif; ?>
                                                <?php if($pacote->localizacao_atual == 'protocolo'): ?>
                                                    <a href="#" class="btn btn-sm btn-success btn-mover-pacote" 
                                                       data-id="<?php echo e($pacote->id); ?>" data-localizacao="<?php echo e($pacote->localizacao_atual); ?>">
                                                        <i class="fas fa-arrow-right"></i>
                                                    </a>
                                                <?php endif; ?>
                                                <a href="<?php echo e(route('pacotes.movimentacoes', $pacote->id)); ?>" class="btn btn-sm btn-secondary">
                    ...
                    <?php if(count($pacotes->where('localizacao_atual', 'protocolo')) == 0 && 
                ...
                <!-- TAB LISURA -->
                <div class="tab-pane fade <?php echo e($localizacaoAtiva == 'lisura' ? 'show active' : ''); ?>" id="lisura" role="tabpanel" aria-labelledby="lisura-tab">
                    <div class="mb-3">
                        <button id="mover-lote-lisura" class="btn btn-secondary">
                            <i class="fas fa-exchange-alt"></i> Mover em Lote
                        </button>
                    ...
                    <table id="tabela-lisura" class="table table-bordered table-striped dataTable">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $pacotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pacote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($pacote->localizacao_atual == 'lisura'): ?>
                                    <tr>
                                        <td><input type="checkbox" class="check-item-lisura" value="<?php echo e($pacote->id); ?>"></td>
                                        <td><?php echo e($pacote->id); ?></td>
                                        <td><?php echo e($pacote->numero_fatura); ?></td>
                                        <td><?php echo e(optional($pacote->ocsPsa)->nome); ?></td>
                                        <td><?php echo e(date('d/m/Y', strtotime($pacote->data_entrada))); ?></td>
                                        ...
                                        <td><?php echo e(optional($pacote->tipoPacote)->nome); ?></td><!-- Alterado: exibe o tipo do pacote ao invés do valor pendente -->
                                        <td>
                                            <span class="badge badge-<?php echo e($pacote->estado_geral == 'Normal' ? 'success' : 'warning'); ?>">
                                                <?php echo e($pacote->estado_geral); ?>
                                            ...
                                            <br>
                                            <span class="badge badge-<?php echo e($pacote->estado_glosa == 'Não identificada' ? 'secondary' : 'danger'); ?>">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <?php if(Auth::user()->role == 'admin' || Auth::user()->role == 'lisura'): ?>
                                                    <a href="<?php echo e(route('pacotes.edit', $pacote->id)); ?>" class="btn btn-sm btn-primary">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <a href="#" class="btn btn-sm btn-success btn-mover-pacote" 
                    ...
                    <?php if(count($pacotes->where('localizacao_atual', 'lisura')) == 0): ?>
                ...
                <!-- TAB SIRE -->
                <div class="tab-pane fade <?php echo e($localizacaoAtiva == 'sire' ? 'show active' : ''); ?>" id="sire" role="tabpanel" aria-labelledby="sire-tab">
                    <div class="mb-3">
                    ...
                    <table id="tabela-sire" class="table table-bordered table-striped dataTable">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $pacotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pacote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($pacote->localizacao_atual == 'sire' || ($pacote->localizacao_atual == 'glosa' && $pacote->valor_pendente > 0)): ?>
                                    <tr class="<?php echo e($pacote->localizacao_atual == 'glosa' ? 'bg-warning-light' : ''); ?>">
                                        <td><input type="checkbox" class="check-item-sire" value="<?php echo e($pacote->id); ?>"></td>
                                        <td><?php echo e($pacote->id); ?></td>
                                        <td><?php echo e($pacote->numero_fatura); ?></td>
                                        <td><?php echo e(optional($pacote->ocsPsa)->nome); ?></td>
                                        <td><?php echo e(date('d/m/Y', strtotime($pacote->data_entrada))); ?></td>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <?php if(Auth::user()->role == 'admin' || Auth::user()->role == $pacote->localizacao_atual): ?>
                                                    <a href="#" class="btn btn-sm btn-success btn-mover-pacote" 
                                                       data-id="<?php echo e($pacote->id); ?>" 
                                                       data-localizacao="<?php echo e($pacote->localizacao_atual); ?>"
                                                       data-destino="glosa">
                    ...
                    <?php if(count($pacotes->where('localizacao_atual', 'sire')) == 0 && count($pacotes->where('localizacao_atual', 'glosa')->where('valor_pendente', '>', 0)) == 0): ?>
                        <div class="alert alert-info mt-3">
                            Nenhum pacote encontrado para esta localização.
                        </div>
                    <?php endif; ?>
                ...
                <!-- TAB GLOSA -->
                <div class="tab-pane fade <?php echo e($localizacaoAtiva == 'glosa' ? 'show active' : ''); ?>" id="glosa" role="tabpanel" aria-labelledby="glosa-tab">
                    <table id="tabela-glosa" class="table table-bordered table-striped dataTable">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $pacotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pacote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($pacote->localizacao_atual == 'glosa'): ?>
                                    <tr class="<?php echo e($pacote->estado_glosa == 'Aguardando Recurso de Glosa' ? 'aguardando-recurso' : ''); ?>">
                                        <td>
                                            <input type="checkbox" class="check-item-glosa" value="<?php echo e($pacote->id); ?>">
                                        </td>
                                        <td><?php echo e($pacote->id); ?></td>
                                        <td><?php echo e($pacote->numero_fatura); ?></td>
                                        <td><?php echo e(optional($pacote->ocsPsa)->nome); ?></td>
                    ...
                    <?php if(count($pacotes->where('localizacao_atual', 'glosa')) == 0): ?>
                        <div class="alert alert-info">
                ...
                <!-- TAB ARQUIVO -->
                <div class="tab-pane fade <?php echo e($localizacaoAtiva == 'arquivo' ? 'show active' : ''); ?>" id="arquivo" role="tabpanel" aria-labelledby="arquivo-tab">
                    <div class="mb-3">
                    ...
                    <table id="tabela-arquivo" class="table table-bordered table-striped dataTable">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $pacotes->where('localizacao_atual', 'arquivo'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pacote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><input type="checkbox" class="check-item-arquivo" value="<?php echo e($pacote->id); ?>"></td>
                                    <td><?php echo e($pacote->id); ?></td>
                                    <td><?php echo e($pacote->numero_fatura); ?></td>
                                    <td><?php echo e(optional($pacote->ocsPsa)->nome); ?></td>
                                    <td><?php echo e(date('d/m/Y', strtotime($pacote->data_entrada))); ?></td>
                                    ...
                                    <td>
                                        ...
                                        <?php if(Auth::user()->role == 'admin' || Auth::user()->role == 'arquivo'): ?>
                                            <a href="#" class="btn btn-sm btn-primary btn-arquivar" 
                                               ...
                                               data-id="<?php echo e($pacote->id); ?>" data-localizacao-fisica="<?php echo e($pacote->localizacao_fisica ?? ''); ?>">
                    ...
                    <?php if(count($pacotes->where('localizacao_atual', 'arquivo')) == 0): ?>
                        <div class="alert alert-info mt-3">
                            Nenhum pacote encontrado para esta localização.
                        </div>
                    <?php endif; ?>
                ...
                <!-- TAB ARQUIVADOS -->
                <div class="tab-pane fade <?php echo e($localizacaoAtiva == 'arquivados' ? 'show active' : ''); ?>" id="arquivados" role="tabpanel" aria-labelledby="arquivados-tab">
                    <table id="tabela-arquivados" class="table table-bordered table-striped dataTable">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $pacotes->where('localizacao_atual', 'arquivado'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pacote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><input type="checkbox" class="check-item-arquivados" value="<?php echo e($pacote->id); ?>"></td>
                                    <td><?php echo e($pacote->id); ?></td>
                                    <td><?php echo e($pacote->numero_fatura); ?></td>
                                    <td><?php echo e(optional($pacote->ocsPsa)->nome); ?></td>
                                    <td>R$ <?php echo e(number_format($pacote->valor_fatura, 2, ',', '.')); ?></td>
                                    <td>R$ <?php echo e(number_format($pacote->valor_pos_lisura, 2, ',', '.')); ?></td>
                                    <td>R$ <?php echo e(number_format($pacote->valor_glosa, 2, ',', '.')); ?></td>
                                    <td><?php echo e($pacote->estado_glosa); ?></td>
                                    <td><?php echo e($pacote->localizacao_fisica ?? 'Não informada'); ?></td>
                                    <td>
                                        <a href="<?php echo e(route('pacotes.show', $pacote->id)); ?>" class="btn btn-sm btn-info">
                                            <i class="fas fa-eye"></i>
                                        </a>
                    ...
                    <?php if(count($pacotes->where('localizacao_atual', 'arquivado')) == 0): ?>
                        <div class="alert alert-info mt-3">
                            Nenhum pacote encontrado para esta localização.
                        </div>
                    <?php endif; ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            function configurarModal(pacoteId, localizacao, destinoForcado = '') {
                ...
                $('#formMoverPacote').attr('action', '<?php echo e(url("pacotes")); ?>/' + pacoteId + '/mover');
            ...
            $('#modalArquivar').on('show.bs.modal', function(e) {
                ...
                $('#formArquivar').attr('action', '<?php echo e(url("pacotes")); ?>/' + pacoteId + '/arquivar');
            ...
            $('#modalEditarLocalizacaoFisica').on('show.bs.modal', function(e) {
                ...
                // Definir a ação do formulário
                $('#formEditarLocalizacaoFisica').attr('action', '<?php echo e(url("pacotes")); ?>/' + pacoteId + '/atualizar-localizacao-fisica');
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/admin21ct/pmed2/resources/views/pacotes/index.blade.php ENDPATH**/ ?>