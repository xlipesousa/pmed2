    ...
    <div class="row">
        <div class="col-lg-2 col-6">
            <div class="small-box bg-info">
                <div class="inner">
                    <h3>{{ App\Models\Pacote::where('localizacao_atual', 'Protocolo')->count() }}</h3>
                    <p>Protocolo</p>
                </div>
                <div class="icon">
                    <i class="fas fa-inbox"></i>
                </div>
                <a href="{{ route('pacotes.index') }}?aba=protocolo#protocolo" class="small-box-footer">
        ...
        <div class="col-lg-2 col-6">
            <div class="small-box bg-success">
                <div class="inner">
                    <h3>{{ App\Models\Pacote::where('localizacao_atual', 'Lisura')->count() }}</h3>
                    <p>Lisura</p>
                </div>
                <div class="icon">
                    <i class="fas fa-check-circle"></i>
                </div>
                <a href="{{ route('pacotes.index') }}?aba=lisura#lisura" class="small-box-footer">
                    Ver detalhes <i class="fas fa-arrow-circle-right"></i>
                </a>
            </div>
        </div>
        ...
        <div class="col-lg-2 col-6">
            <div class="small-box bg-warning">
                <div class="inner">
                    <h3>{{ App\Models\Pacote::where('localizacao_atual', 'SIRE')->count() }}</h3>
                    <p>SIRE</p>
                </div>
                <div class="icon">
                    <i class="fas fa-money-bill-alt"></i>
                </div>
                <a href="{{ route('pacotes.index') }}?aba=sire#sire" class="small-box-footer">
                    Ver detalhes <i class="fas fa-arrow-circle-right"></i>
                </a>
            </div>
        </div>
        ...
        <div class="col-lg-2 col-6">
            <div class="small-box bg-danger">
                <div class="inner">
                    <h3>{{ App\Models\Pacote::where('localizacao_atual', 'Glosa')->count() }}</h3>
                    <p>Glosa</p>
                </div>
                <div class="icon">
                    <i class="fas fa-exclamation-triangle"></i>
                </div>
                <a href="{{ route('pacotes.index') }}?aba=glosa#glosa" class="small-box-footer">
                    Ver detalhes <i class="fas fa-arrow-circle-right"></i>
                </a>
            </div>
        </div>
        ...
        <div class="col-lg-2 col-6">
            <div class="small-box bg-primary">
                <div class="inner">
                    <h3>{{ App\Models\Pacote::where('localizacao_atual', 'Arquivo')->count() }}</h3>
                    <p>Arquivo</p>
                </div>
                <div class="icon">
                    <i class="fas fa-archive"></i>
                </div>
                <a href="{{ route('pacotes.index') }}?aba=arquivo#arquivo" class="small-box-footer">
                    Ver detalhes <i class="fas fa-arrow-circle-right"></i>
                </a>
            </div>
        </div>
        ...
        <div class="col-lg-2 col-6">
            <div class="small-box bg-secondary">
                <div class="inner">
                    <h3>{{ App\Models\Pacote::where('localizacao_atual', 'arquivado')->count() }}</h3>
                    <p>Arquivados</p>
                </div>
                <div class="icon">
                    <i class="fas fa-file-archive"></i>
                </div>
                <a href="{{ route('pacotes.index') }}?aba=arquivado#arquivado" class="small-box-footer">
                    Ver detalhes <i class="fas fa-arrow-circle-right"></i>
                </a>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-6">
            <div class="info-box bg-gradient-info">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">R$ {{ number_format(App\Models\Pacote::sum('valor_fatura'), 2, ',', '.') }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-6">
            <div class="info-box bg-gradient-success">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">R$ {{ number_format(App\Models\Pacote::sum('valor_pago'), 2, ',', '.') }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-6">
            <div class="info-box bg-gradient-warning">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">R$ {{ number_format(App\Models\Pacote::sum('valor_glosa'), 2, ',', '.') }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-6">
            <div class="info-box bg-gradient-danger">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">R$ {{ number_format(App\Models\Pacote::whereRaw('valor_fatura > IFNULL(valor_pago, 0) + IFNULL(valor_glosa, 0)')->sum(DB::raw('valor_fatura - IFNULL(valor_pago, 0) - IFNULL(valor_glosa, 0)')), 2, ',', '.') }}</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card card-danger">
                    ...
                    <div class="table-responsive">
                        <table class="table m-0">
                            ...
                            <tbody>
                                ...
                                @forelse($pacotesAlerta as $pacote)
                                <tr>
                                    <td><a href="{{ route('pacotes.show', $pacote->id) }}">{{ $pacote->id }}</a></td>
                                    <td>{{ $pacote->ocsPsa->nome ?? 'N/A' }}</td>
                                    <td>
                                        <span class="badge badge-warning">{{ $pacote->localizacao_atual }}</span>
                                    </td>
                                    <td>
                                        <small class="badge badge-danger">
                                            <i class="far fa-clock"></i> 
                                            {{ (int)$pacote->diasRetiradaRestantes() }} dias restantes
                                        </small>
                                    </td>
                                    <td>
                                        <a href="{{ route('pacotes.prazos', $pacote->id) }}" class="btn btn-xs btn-info">
                ...
                <div class="card-footer text-center">
                    <a href="{{ route('relatorios.glosas') }}" class="btn btn-sm btn-danger">
        ...
        <div class="col-md-6">
            <div class="card card-info">
                    ...
                    <div class="table-responsive">
                        <table class="table m-0">
                            ...
                            <tbody>
                                ...
                                @forelse($topOcsPsa as $ocs)
                                <tr>
                                    <td>{{ $ocs->nome }}</td>
                                    <td>{{ $ocs->total_pacotes }}</td>
                                    <td>R$ {{ number_format($ocs->valor_total, 2, ',', '.') }}</td>
                                    <td>
                                        @php 
                                            $taxaGlosa = $ocs->valor_total > 0 ? 
                                                ($ocs->valor_glosa / $ocs->valor_total) * 100 : 0;
                                        @endphp
                                        {{ number_format($taxaGlosa, 1) }}%
                                    </td>
                                </tr>
                                @empty
                                <tr>
                ...
                <div class="card-footer text-center">
                    <a href="{{ route('relatorios.ocspsa') }}" class="btn btn-sm btn-info">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            <a href="{{ route('pacotes.create') }}" class="btn btn-app bg-primary" style="width: 100%;">
                                <i class="fas fa-plus-circle"></i> Novo Pacote
                            </a>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <a href="{{ route('relatorios.status-pacotes') }}" class="btn btn-app bg-info" style="width: 100%;">
                                <i class="fas fa-chart-pie"></i> Status de Pacotes
                            </a>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <a href="{{ route('relatorios.financeiro') }}" class="btn btn-app bg-success" style="width: 100%;">
                                <i class="fas fa-dollar-sign"></i> Relatório Financeiro
                            </a>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <a href="{{ route('relatorios.glosas') }}" class="btn btn-app bg-warning" style="width: 100%;">
    ...
    <script>
        $(function() {
            ...
            const counts = [
                ...
                {{ App\Models\Pacote::onlyTrashed()->count() }}
            ];
            ...
            const valores = [
                {{ App\Models\Pacote::where('localizacao_atual', 'Protocolo')->sum('valor_fatura') }},
                {{ App\Models\Pacote::where('localizacao_atual', 'Lisura')->sum('valor_fatura') }},
                {{ App\Models\Pacote::where('localizacao_atual', 'SIRE')->sum('valor_fatura') }},
                {{ App\Models\Pacote::where('localizacao_atual', 'Glosa')->sum('valor_fatura') }},
                {{ App\Models\Pacote::where('localizacao_atual', 'Arquivo')->sum('valor_fatura') }}
            ];
